"""Run Palantir pseudotime on momac metacells using naive Spearman gene intersection."""
...
ax.set_title("Palantir pseudotime (momac)"); ax.set_xlabel("sc_x"); ax.set_ylabel("sc_y")
