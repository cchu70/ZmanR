...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_mcumi_full_smooth_ctet/scorpius_pseudotime.png"
...
genes <- load_ctet_mos_genes("mcumi", geneset="full", timecol="smooth_ctet")
...
save_pseudotime_plot(dat$sc_x, dat$sc_y, traj$time, OUT_PLOT, "SCORPIUS pseudotime (mcumi full_smooth_ctet)")
