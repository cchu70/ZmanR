"""Run Palantir pseudotime on scumi metacells using zman_s3 gene set."""
...
OUT_PLOT   = "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_scumi_zman_s3/palantir_pseudotime.png"
...
ax.set_title("Palantir pseudotime (scumi zman_s3)"); ax.set_xlabel("sc_x"); ax.set_ylabel("sc_y")
