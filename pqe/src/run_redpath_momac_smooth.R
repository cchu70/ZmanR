...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_momac_smooth/redpath_pseudotime.png"
...
# Smooth gene set is small (19 genes); skip dispersion filter and use narrow range
...
save_pseudotime_plot(dat$sc_x, dat$sc_y, pseudotime, OUT_PLOT, "redPATH pseudotime (momac smooth)")
