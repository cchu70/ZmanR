...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_mcumi_hvg_ctet/dpt_pseudotime.png"
...
save_pseudotime_plot(dat$sc_x, dat$sc_y, pt_root, OUT_PLOT, "DPT pseudotime (mcumi hvg_ctet)")
