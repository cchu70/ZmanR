...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_momac/dpt_pseudotime.png"
...
cat("Computing DPT...\n")
dpt <- DPT(dm, tips = 1L)
save_pseudotime_plot(dat$sc_x, dat$sc_y, dpt$DPT1, OUT_PLOT, "DPT pseudotime (momac)")
