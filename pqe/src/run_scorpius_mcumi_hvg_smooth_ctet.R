...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_mcumi_hvg_smooth_ctet/scorpius_pseudotime.png"
...
save_pseudotime_plot(dat$sc_x, dat$sc_y, traj$time, OUT_PLOT, "SCORPIUS pseudotime (mcumi hvg_smooth_ctet)")
