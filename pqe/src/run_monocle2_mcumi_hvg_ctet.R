...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_mcumi_hvg_ctet/monocle2_pseudotime.png"
...
genes <- load_ctet_mos_genes("mcumi", geneset="hvg", timecol="ctet")
...
save_pseudotime_plot(dat$sc_x, dat$sc_y, pseudotime, OUT_PLOT, "Monocle2 pseudotime (mcumi hvg_ctet)")
