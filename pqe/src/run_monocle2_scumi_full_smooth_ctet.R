...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_scumi_full_smooth_ctet/monocle2_pseudotime.png"
...
genes <- load_ctet_mos_genes("scumi", geneset="full", timecol="smooth_ctet")
...
save_pseudotime_plot(dat$sc_x, dat$sc_y, pseudotime, OUT_PLOT, "Monocle2 pseudotime (scumi full_smooth_ctet)")
