"""Run Palantir pseudotime on momac metacells using full naive Spearman gene intersection."""
...
OUT_PLOT   = "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_momac_full/palantir_pseudotime.png"
REPO       = "/home/unix/cchu/projects/ZmanR/pqe/results/06"

igg_df   = pd.read_csv(f"{REPO}/igg_full_spearman_df.naive.csv",   index_col=0)
atrem_df = pd.read_csv(f"{REPO}/atrem_full_spearman_df.naive.csv", index_col=0)
...
print(f"Full naive gene intersection: {len(genes)} genes")
...
ax.set_title("Palantir pseudotime (momac full)"); ax.set_xlabel("sc_x"); ax.set_ylabel("sc_y")
