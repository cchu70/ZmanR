...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_mcumi_hvg_smooth_ctet/monocle2_pseudotime.png"
...
genes <- load_ctet_mos_genes("mcumi", geneset="hvg", timecol="smooth_ctet")
...
save_pseudotime_plot(dat$sc_x, dat$sc_y, pseudotime, OUT_PLOT, "Monocle2 pseudotime (mcumi hvg_smooth_ctet)")
