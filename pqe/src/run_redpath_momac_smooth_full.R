...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_momac_smooth_full/redpath_pseudotime.png"
...
# Small gene set (~57 genes); skip dispersion filter and use narrow base_path_range
...
save_pseudotime_plot(dat$sc_x, dat$sc_y, pseudotime, OUT_PLOT, "redPATH pseudotime (momac smooth_full)")
