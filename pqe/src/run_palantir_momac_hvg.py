"""Run Palantir pseudotime on momac metacells using adata HVGs."""
...
OUT_PLOT   = "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_momac_hvg/palantir_pseudotime.png"
...
ax.set_title("Palantir pseudotime (momac HVG)"); ax.set_xlabel("sc_x"); ax.set_ylabel("sc_y")
