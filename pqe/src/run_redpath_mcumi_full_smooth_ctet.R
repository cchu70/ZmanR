...
OUT_PLOT   <- "/home/unix/cchu/projects/ZmanR/pqe/results/pseudotime_mcumi_full_smooth_ctet/redpath_pseudotime.png"
...
save_pseudotime_plot(dat$sc_x, dat$sc_y, pseudotime, OUT_PLOT, "redPATH pseudotime (mcumi full_smooth_ctet)")
