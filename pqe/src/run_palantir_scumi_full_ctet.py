"""Run Palantir pseudotime on scumi metacells using full_ctet gene set."""
...
atrem_df = pd.read_csv(f"/home/unix/cchu/projects/ZmanR/pqe/results/06/ctet_mos/spearman/scumi_atrem_full_ctet_spearman.csv", index_col=0)
...
ax.set_title("Palantir pseudotime (scumi full_ctet)"); ax.set_xlabel("sc_x"); ax.set_ylabel("sc_y")
